                ...
                <div className="space-y-4">
                    {transactions.map(tx => (
                        <div key={tx._id} className="border p-4 bg-white ">
                            <div className="font-medium break-all text-sm sm:text-base mb-2">
                                <span className="block sm:inline">Transaction ID:</span>
                                <span className="ml-1 break-all">{tx.transactionId}</span>
                            </div>
