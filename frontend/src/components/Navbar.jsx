        ...
        <div className="flex items-center justify-between py-5 font-medium">
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="group relative">
                    ...
                    {/* dropdown  */}
                    {token && <div className="group-hover:block hidden absolute dropdown-menu right-00 pt-4">
            ...
            <div className={`absolute top-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? "w-full" : "w-0 "}`}>
                <div className=" flex flex-col text-gray-600">
                    ...
                    <NavLink onClick={() => setVisible(false)} className={"py-2 pl-6 border"} to={"https://forever-admin-plum.vercel.app/"}>Admin Panel</NavLink>
                </div>
            </div>
